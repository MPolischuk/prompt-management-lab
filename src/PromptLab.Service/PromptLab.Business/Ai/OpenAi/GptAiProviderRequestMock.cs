...
/// <summary>
/// Simula respuestas del proveedor OpenAI sin llamadas HTTP.
/// </summary>
public class GptAiProviderRequestMock : IGptAiProviderRequestClient
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var output =
            $"[MOCK:openai] Model={request.ModelId} Prompt='{prompt.Title}' — {text}";
