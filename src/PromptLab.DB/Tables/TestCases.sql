...
(
    ...
    [InputVariables] NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NOT NULL CONSTRAINT [DF_TestCases_InputVariables] DEFAULT (N'{}'),
    [ExpectedOutput] NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
