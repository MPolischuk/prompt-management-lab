...
(
    ...
    [Provider] NVARCHAR(50) COLLATE DATABASE_DEFAULT NOT NULL,
    [ModelId] NVARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
    [Input] NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
    [Output] NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
    [Temperature] DECIMAL(4, 2) NULL,
    [MaxTokens] INT NULL,
    [TopP] DECIMAL(4, 2) NULL,
    [PromptSnapshot] NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
    [PromptSnapshotHash] NVARCHAR(128) COLLATE DATABASE_DEFAULT NULL,
    [Status] NVARCHAR(20) COLLATE DATABASE_DEFAULT NOT NULL,
    [ErrorMessage] NVARCHAR(2000) COLLATE DATABASE_DEFAULT NULL,
    [LatencyMs] INT NULL,
